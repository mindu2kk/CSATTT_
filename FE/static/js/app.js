...
// All blockchain contracts are managed in blockchain-books.js
// Access via: window.blockchainBooks.bookNFTContract, etc.
// ========================================

// Legacy variables - USE window.blockchainBooks instead!
// These are kept for backward compatibility only
let provider = null;  // Use: window.walletState.provider
let signer = null;    // Use: window.walletState.signer
let userAddress = null;  // Use: window.walletState.address

// DEPRECATED - Use window.blockchainBooks.bookNFTContract
let bookNFTContract = null;
// DEPRECATED - Use window.blockchainBooks.libraryCoreContract
let libraryCoreContract = null;
// DEPRECATED
let escrowVaultContract = null;
// DEPRECATED - Use window.blockchainBooks.contracts
let contracts = null;
