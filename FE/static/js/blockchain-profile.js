...
class BlockchainProfileManager {
    ...
    async loadContracts() {
        try {
            ...
            if (window.walletState && window.walletState.isConnected && window.walletState.signer) {
                this.userProfileContract = new ethers.Contract(
                    window.blockchainBooks.contracts.userProfile,
                    USER_PROFILE_ABI,
                    window.walletState.signer
                );
                console.log('UserProfile contract loaded:', window.blockchainBooks.contracts.userProfile);
            }
