...
export declare namespace UserProfileV2 {
...
export interface UserProfileV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizedUpdaters"
      | "createProfile"
...
export interface UserProfileV2 extends BaseContract {
  connect(runner?: ContractRunner | null): UserProfileV2;
  waitForDeployment(): Promise<this>;

  interface: UserProfileV2Interface;
  ...
  getProfile: TypedContractMethod<
    [_user: AddressLike],
    [UserProfileV2.ProfileStructOutput],
    "view"
  >;
  ...
  filters: {
    ...
    "ReputationUpdated(address,uint256,uint256,address)": TypedContractEvent<
      ReputationUpdatedEvent.InputTuple,
      ReputationUpdatedEvent.OutputTuple,
      ReputationUpdatedEvent.OutputObject
    >;
